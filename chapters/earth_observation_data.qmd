...
We have rebuilt, optimized, and fully automated version 2.0 of our crop type mapping pipeline (Sentinel-1 OBIA & ANN/SAM). The code has been successfully pushed to a [dedicated branch on GitHub](https://github.com/AIML4OS/WP7-Crop-type-mapping/){target="_blank"}. 
