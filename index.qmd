...
wp_df <- tibble::tribble(
  ~title, ~link,
  'Project Management & Coordination', 'chapters/coordination.qmd',
  'Communication', 'chapters/communication.qmd',
  'AI/ML Lab', 'chapters/aiml_lab.qmd',
  'Ecosystem Monitoring', 'https://aiml4os.github.io/WP4/',
  'Standards, Methodology & Implementation', 'chapters/standards_methodology_implementation.qmd',
  'Knowledge Repository', 'chapters/knowledge_repository.qmd',
  
  'Earth Observation Data','chapters/earth_observation_data.qmd',
  'Editing', 'https://aiml4os.github.io/WP8/',
  'Imputation', 'chapters/imputation.qmd',
  'Text to Code', 'https://aiml4os.github.io/WP10/',
  'Supply Chain Networks', 'chapters/supply_chain_networks.qmd',
  'LLMs', 'chapters/llms.qmd',
  'Synthetic Data', 'chapters/synthetic_data.qmd'
) |>
...
for(i in 1:nrow(wp_df)){
  ...
  cat(glue('
  <div class="media-row" style = "display:flex; align-items:center; margin-bottom:1rem;">
  <a href="{wp_df$link[i]}">
    <img src="{wp_df$img[i]}" style="width:120px; height:120px; object-fit:cover; margin-right:1rem;">
  </a>
    <div>
    **<a href="{wp_df$link[i]}">{wp_df$title[i]}</a>**
    </div>
