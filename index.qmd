...
- We will be at the **European Conference on Quality in Official Statistics** (Q2026), which will take place from 3 to 5 June 2026 in Šibenik, Croatia. A full list of AIML4OS presentations at this conference is available on our [news page](chapters/news.qmd).
- We will have a [**two-day funathon beginning on May 27th**](https://aiml4os.github.io/funathon-general-website/about.html){target="_blank"}. This is a non-competitive hackathon, which will provide ESS staff with an opportunity to learn and apply machine learning and AI methods in a collaborative and supportive environment.
