...
- We have produced a [**repository of useful resources**](chapters/useful_links2.qmd){target="_blank"} which are related to the topics covered by AIML4OS. 
...
for(i in 1:nrow(wp_df)){
  ...
  <a href="{wp_df$link[i]}">
    <img src="{wp_df$img[i]}" style="width:80px; height:80px; object-fit:cover; margin-right:1rem;">
  </a>
    <div>
